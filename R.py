...
async def add_user(update: Update, context: CallbackContext):
    user_id = update.effective_user.id
    if user_id != ADMIN_USER_ID:
        await context.bot.send_message(chat_id=update.effective_chat.id, text="*❌ YE BOT FREE NAHI H JISE LENA H BUY KARO @RAJPUTDDOS❌!!*", parse_mode='Markdown')
        return
